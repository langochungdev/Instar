...
INSERT INTO users (username, email, password, full_name, avatar_url, bio, created_at, is_active, is_verified, role)
VALUES ('admin', 'admin@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'La Hung Admin',
        NULL, N'Chào mọi người!', GETDATE(), 1, 1, 'ADMIN'),
       ('user', 'user@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'La Hung user', NULL,
        N'Yêu du lịch', GETDATE(), 1, 1, 'USER'),
       ('user0', 'user0@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'La Hung user',
        NULL, NULL, GETDATE(), 1, 0, 'USER'),
       ('david', 'david@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'David Hồ', NULL,
        N'Lập trình viên', GETDATE(), 1, 1, 'USER'),
       ('emma', 'emma@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Emma Phạm', NULL,
        N'Thích đọc sách', GETDATE(), 1, 1, 'USER'),
       ('frank', 'frank@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Frank Võ', NULL,
        NULL, GETDATE(), 1, 0, 'USER'),
       ('grace', 'grace@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Grace Đặng', NULL,
        N'Sống ảo 100%', GETDATE(), 1, 1, 'USER'),
       ('henry', 'henry@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Henry Vũ', NULL,
        NULL, GETDATE(), 1, 0, 'USER'),
       ('ivy', 'ivy@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Ivy Hồ', NULL,
        N'Tôi là Ivy', GETDATE(), 1, 1, 'USER'),
       ('jack', 'jack@email.com', '$2a$12$.NALdJeDlmXUugMWI2AniO5CbhgsPWm9gDkWxZPA4nj/t118ieHRS', N'Jack Nguyễn', NULL,
        NULL, GETDATE(), 1, 1, 'USER');

-- CHATS
INSERT INTO chats (chat_name, is_group, created_by, created_at)
...
-- POSTS
INSERT INTO posts (user_id, content, created_at, is_deleted)
VALUES (1, N'Bài đầu tiên của mình!', GETDATE(), 0),
...
VALUES (1, 1, N'Hello user!', GETDATE(), 1),
...
VALUES (1, 'chat_img1.jpg', 'image'),
       (2, 'tailieu.pdf', 'pdf'),
       (5, 'video_group.mp4', 'video'),
       (5, 'hinhanh_group.png', 'image'),
       (8, 'docx1.docx', 'other');

-- INSERT INTO devices (user_id, device_token, device_name, last_login, is_active)
-- VALUES (1, 'token1', N'iPhone 13', GETDATE(), 1),
...
-- VALUES (1, 'like', N'Bob đã thích bài viết của bạn', NULL, 0, GETDATE()),
...
-- INSERT INTO user_behaviors (user_id, action, target_id, created_at)
-- VALUES (1, 'view_post', 2, GETDATE()),
